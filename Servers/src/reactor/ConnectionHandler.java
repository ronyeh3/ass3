...
public class ConnectionHandler<T> {
	...
	private void initialize() {
		...
		_callback =_data.getCallbackFactory().create(this);
	}
	...
	public synchronized void addOutData(T msg) throws CharacterCodingException {
		try {
			_outData.add(_tokenizer.getBytesForMessage(msg));
	 ...
	 */
	public ProtocolCallback<T> getCallback() {
		return _callback;
	}
